...
from crypto_regime_backtest.funding_positive_panel_validation import (
    AssetFrames,
    StrategySpec,
    build_signal_panel,
)
...
def test_build_signal_panel_selects_single_most_positive_asset_per_timestamp_and_applies_cooldown():
