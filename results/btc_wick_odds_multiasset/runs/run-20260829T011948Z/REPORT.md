...
## Hostile checks
        ...
        doubled_cost    9713.335325        True         True                  NaN                       NaT
  exclude_best_event    9651.153653        True         True                  XRP 2025-04-10 02:00:00+00:00
best_event_pnl_share           <NA>        <NA>         <NA>                  NaN                       NaT
per_asset_trades_BTC       0.113111           1         <NA>                  NaN                       NaT
per_asset_trades_ETH      -0.018284           6         <NA>                  NaN                       NaT
per_asset_trades_SOL        0.01019           9         <NA>                  NaN                       NaT
per_asset_trades_XRP       0.013712           7         <NA>                  NaN                       NaT

## Verdict

{
  "label": "rejected",
  "reason": "Pooling ETH/SOL/XRP wick events into the same sleeve produced a net LOSS on committed capital, even though it beat the (also-negative) DCA baselines in this bearish sample window. Beating a losing benchmark is not evidence of edge; the decisive comparison is against zero/breakeven. Diluting the BTC-only signal with other assets made results worse, not better.",
  "event_count": 23,
  "beats_both_dca": true,
